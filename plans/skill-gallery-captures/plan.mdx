...
| 5 | `tui-puppeteering-with-tmux` | Verbatim text of the Nori CLI start menu, after a sent keystroke | Done |
...
| `tui-puppeteering-with-tmux/captures/` | New text capture (not an image) |
