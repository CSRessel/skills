...
| 5 | `tui-puppeteering-with-tmux` | `fzf` driven by a sent query, proved with `tui-assert` | Done |
...
Three things worth keeping, all discovered by running the skills rather than
reading them:
